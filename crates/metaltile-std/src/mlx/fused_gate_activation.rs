...
mod tests_support {
    ...
    #[test_kernel(name = "mlx/fused_gate_gelu", dtypes = [f32], tol = 1e-4)]
    fn test_fused_gate_gelu_f32(dt: DType) -> TestSetup {
        let n = 1024usize;
    ...
    #[test_kernel(name = "mlx/fused_gate_clipped_swiglu", dtypes = [f32], tol = 1e-4)]
    fn test_fused_gate_clipped_swiglu_f32(dt: DType) -> TestSetup {
        let n = 1024usize;
        // Range spans past ±7 to exercise the clamp branch.
