...
use metaltile::test_kernel;
    ...
    fn make_setup(dt: DType, m: usize, n: usize, k: usize) -> TestSetup {
        ...
        let mut kernel = mt_steel_gemm_fused_nax::kernel_ir_for(dt);
    ...
    #[test_kernel(name = "steel/gemm_fused_nax_f32_small", dtypes = [f32], tol = 1e-3)]
    fn test_gemm_fused_nax_f32_small(dt: DType) -> TestSetup { make_setup(dt, 32, 32, 32) }

    #[test_kernel(name = "steel/gemm_fused_nax_f32_multi_k", dtypes = [f32], tol = 1e-3)]
