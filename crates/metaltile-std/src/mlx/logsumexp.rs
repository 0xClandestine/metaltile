...
mod tests_support {
    ...
    fn test_logsumexp_n1024_rows4_f32(dt: DType) -> TestSetup {
        make_setup(1024, 4, dt)
    }

    #[test_kernel(name = "mlx/logsumexp/n256_rows8_f32", dtypes = [f32], tol = 1e-3)]
    fn test_logsumexp_n256_rows8_f32(dt: DType) -> TestSetup {
        make_setup(256, 8, dt)
    }

    #[test_kernel(name = "mlx/logsumexp/n1024_rows2_f16", dtypes = [f16], tol = 5e-2)]
    fn test_logsumexp_n1024_rows2_f16(dt: DType) -> TestSetup {
