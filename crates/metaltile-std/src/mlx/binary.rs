...
pub mod kernel_benches {
    ...
    fn bench_vector_add(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(vector_add::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "c")
    }

    #[bench(name = "binary/mul", dtypes = [f32, f16, bf16])]
    fn bench_mt_mul(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_mul::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "out")
    }

    #[bench(name = "binary/sub", dtypes = [f32, f16, bf16])]
    fn bench_mt_sub(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_sub::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "out")
    }

    #[bench(name = "binary/div", dtypes = [f32, f16, bf16])]
    fn bench_mt_div(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_div::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "out")
    }

    #[bench(name = "binary/maximum", dtypes = [f32, f16, bf16])]
    fn bench_mt_max_elem(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_max_elem::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "out")
    }

    #[bench(name = "binary/minimum", dtypes = [f32, f16, bf16])]
    fn bench_mt_min_elem(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_min_elem::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "out")
    }

    #[bench(name = "binary/pow", dtypes = [f32, f16, bf16])]
    fn bench_mt_pow(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_pow::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "out")
    }

    #[bench(name = "binary/atan2", dtypes = [f32, f16, bf16])]
    fn bench_mt_atan2(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_atan2::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "y", "x", "out")
    }

    #[bench(name = "binary/remainder", dtypes = [f32, f16, bf16])]
    fn bench_mt_remainder(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_remainder::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "out")
    }

    #[bench(name = "binary/logaddexp", dtypes = [f32, f16, bf16])]
    fn bench_mt_logaddexp(dt: DType) -> BenchSetup {
        crate::benches::bench_binary(mt_logaddexp::kernel_ir_for(dt), dt, crate::benches::ELEMENTWISE_N, crate::benches::ELEMENTWISE_TPG, "a", "b", "out")
    }
}
