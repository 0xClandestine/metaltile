...
mod tests_support {
    ...
    fn make_setup(
        ...
        let mut kernel = ffai_sdpa_decode::kernel_ir_for(dt);
        ...
        TestSetup::new(kernel)
            ...
            .constexpr("has_sink", has_sink)
            .constexpr("sink_logit", sink_logit)
            .constexpr("scale", scale)
            .grid_3d(n_q_heads as u32, 1, 1, [1024, 1, 1])
    }

    #[test_kernel(name = "ffai/sdpa_decode/dense_f32", dtypes = [f32], tol = 1e-4)]
    fn test_sdpa_decode_dense(dt: DType) -> TestSetup {
    ...
    #[test_kernel(name = "ffai/sdpa_decode/swa_f32", dtypes = [f32], tol = 1e-4)]
    fn test_sdpa_decode_swa(dt: DType) -> TestSetup {
        let n_q_heads = 2usize;
        let n_kv_heads = 1usize;
        let head_dim = 128usize;
        let n_kv = 16usize;
    ...
    #[test_kernel(name = "ffai/sdpa_decode/swa_no_sinks_f32", dtypes = [f32], tol = 1e-4)]
    fn test_sdpa_decode_swa_no_sinks(dt: DType) -> TestSetup {
        let n_q_heads = 2usize;
        let n_kv_heads = 1usize;
        let head_dim = 128usize;
        let n_kv = 16usize;
    ...
    #[test_kernel(name = "ffai/sdpa_decode/learned_sink_f32", dtypes = [f32], tol = 1e-4)]
    fn test_sdpa_decode_learned_sink(dt: DType) -> TestSetup {
        let n_q_heads = 2usize;
        let n_kv_heads = 1usize;
        let head_dim = 128usize;
        let n_kv = 8usize;
    ...
    #[test_kernel(name = "ffai/sdpa_decode/has_sink_off_stays_dense_f32", dtypes = [f32], tol = 1e-4)]
    fn test_sdpa_decode_has_sink_off_stays_dense(dt: DType) -> TestSetup {
        let n_q_heads = 2usize;
        let n_kv_heads = 1usize;
        let head_dim = 128usize;
        let n_kv = 8usize;
