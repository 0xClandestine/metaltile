...
//! ```
//!
//! Grid is 2D: `[n_heads, head_dim]` workers each processing one
//! `(head, dim)` element. The single sigmoid per head is materialised
//! in registers (compiler will CSE the column-axis broadcast).
...
pub mod kernel_tests {
    ...
    fn setup(n_heads: usize, head_dim: usize, dt: DType) -> TestSetup {
        ...
        TestSetup::new(ffai_attn_head_gate::kernel_ir_for(dt))
            ...
            .grid_2d(n_heads as u32, head_dim as u32, [1, head_dim as u32])
    }
