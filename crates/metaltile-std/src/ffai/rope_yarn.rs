...
mod tests_support {
    ...
    fn naive_rope_yarn(
        ...
        theta_base: f32, factor: f32, low: f32, high: f32, attn_factor: f32,
    ) -> Vec<f32> {
    ...
    fn make_setup(
        ...
        let expected = naive_rope_yarn(&qk_rounded, head_dim, n_heads, position,
                                       theta_base, factor, low, high, attn_factor);
        ...
        TestSetup::new(kernel)
            ...
            .input(TestBuffer::from_vec("attn_factor", attn_factor.to_le_bytes().to_vec(), DType::F32))
