...
mod tests_support {
    ...
    #[test_kernel(name = "ffai/sdpa_bidirectional_d64/no_prefix_f32", dtypes = [f32], tol = 1e-4)]
    fn test_sdpa_bidirectional_d64_no_prefix_f32(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d64_prefix_gqa_f32(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d64_f16(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d64_bf16(dt: DType) -> TestSetup {
        let (n_q_heads, n_kv_heads, head_dim) = (4usize, 2usize, 64usize);
        let (base_kv, n_query) = (12usize, 8usize);
        let kv_stride = base_kv + n_query;
        let scale = 1.0f32 / (head_dim as f32).sqrt();
        ...
        let k_raw = ramp(n_kv_heads * kv_stride * head_dim, 13, 6.0);
        let v_raw = ramp(n_kv_heads * kv_stride * head_dim, 11, 5.0);
        let round_bf16 = |xs: &[f32]| -> Vec<f32> {
            xs.iter().map(|&x| half::bf16::from_f32(x).to_f32()).collect()
        };
        let q = round_bf16(&q_raw);
    ...
    #[test_kernel(name = "ffai/sdpa_bidirectional_d32/no_prefix_f32", dtypes = [f32], tol = 1e-4)]
    fn test_sdpa_bidirectional_d32_no_prefix_f32(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d32_prefix_gqa_f32(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d32_f16(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d32_bf16(dt: DType) -> TestSetup {
        let (n_q_heads, n_kv_heads, head_dim) = (4usize, 2usize, 32usize);
        let (base_kv, n_query) = (12usize, 8usize);
        let kv_stride = base_kv + n_query;
        let scale = 1.0f32 / (head_dim as f32).sqrt();
    ...
    #[test_kernel(name = "ffai/sdpa_bidirectional_d72/no_prefix_f32", dtypes = [f32], tol = 1e-4)]
    fn test_sdpa_bidirectional_d72_no_prefix_f32(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d72_prefix_gqa_f32(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d72_f16(dt: DType) -> TestSetup {
    ...
    fn test_sdpa_bidirectional_d72_bf16(dt: DType) -> TestSetup {
        let (n_q_heads, n_kv_heads, head_dim) = (4usize, 2usize, 72usize);
        let (base_kv, n_query) = (12usize, 8usize);
        let kv_stride = base_kv + n_query;
        let scale = 1.0f32 / (head_dim as f32).sqrt();
