...
#[bench_kernel(op="unary", subop="silu", class=Unary, input=Signed, tol=1e-4)]
#[kernel]
...
#[bench_kernel(op="unary", subop="gelu", class=Unary, input=Signed, tol=1e-4)]
#[kernel]
...
#[bench_kernel(op="unary", subop="relu", class=Unary, input=Signed, tol=1e-6)]
#[kernel]
...
#[bench_kernel(op="unary", subop="exp2", class=Unary, input=Signed, tol=1e-4)]
#[kernel]
...
#[bench_kernel(op="unary", subop="recip", class=Unary, input=Positive, tol=1e-4)]
#[kernel]
