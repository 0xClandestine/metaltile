...
along the contraction (all 20 formats, GPU-verified on f32/f16/bf16).

**Flash KV (closed):** block-scaled flash-SDPA KV now covers every production head
dim — d ∈ {64, 96, 128, 256, 512} × all 20 formats — matching the affine path, with
